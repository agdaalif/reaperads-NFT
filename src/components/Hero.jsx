...
import { payToMint } from '../Reaperads'
    ...
    >
      <div className="flex flex-col justify-center items-center mx-auto py-10">
        <div className="flex flex-col justify-center items-center">
          ...
          <a
            href="https://github.com/agdaalif"
          ...
          >
            ...
            <div className="flex flex-col font-semibold">
              <span className="text-white text-sm">0x0eF...A4F1</span>
              <span className="text-[#e32970] text-xs">Reaperads</span>
            </div>
          </a>
          ...
          <ul className="flex flex-row justify-center space-x-2 items-center my-4">
            ...
            <a
              className="bg-white hover:scale-50 transition-all duration-75 delay-75 rounded-full mx-2"
              href="https://twitter.com/paraboyyyy"
            >
              <img className="w-7 h-7" src={twitter} alt="twitter" />
            </a>
            <a
              className="bg-white hover:scale-50 transition-all duration-75 delay-75 rounded-full mx-2"
              href="https://medium.com/@agdaalif"
            >
          ...
          >
            <span className="text-xs font-bold">{nfts.length}/6</span>
          </div>
        </div>
      </div>
    </div>
